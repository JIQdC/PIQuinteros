...
################################################################
# This is a generated script based on design: CIAA_master
#
...
# source CIAA_master_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# SPI_3wire, pin_control
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {97} \
   ...
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {145} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#UART 1#UART 1#UART 0#UART 0#I2C 1#I2C 1#I2C 0#I2C 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SPI 1#SPI 1#SPI 1#SPI 1#unassigned#unassigned#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#unassigned#tx#rx#rx#tx#scl#sda#scl#sda#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#mosi#miso#sclk#ss[0]#unassigned#unassigned#mdc#mdio} \
   ...
   CONFIG.PCW_SDIO_PERIPHERAL_DIVISOR0 {35} \
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins pin_control_0/S_AXI_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net Net [get_bd_ports adc_sdio_io] [get_bd_pins SPI_3wire_0/adc_sdio]
  ...
  connect_bd_net -net SPI_3wire_0_proc_miso [get_bd_pins SPI_3wire_0/proc_miso] [get_bd_pins processing_system7_0/SPI0_MISO_I]
  connect_bd_net -net pin_control_0_spi_tristate_o [get_bd_pins SPI_3wire_0/tristate_en] [get_bd_pins pin_control_0/spi_tristate_o]
  connect_bd_net -net pin_control_1_hdmi_en_o [get_bd_ports hdmi_en_o] [get_bd_pins pin_control_0/hdmi_en_o]
  connect_bd_net -net pin_control_1_led_green_o [get_bd_ports led_green_o] [get_bd_pins pin_control_0/led_green_o]
  connect_bd_net -net pin_control_1_led_red_o [get_bd_ports led_red_o] [get_bd_pins pin_control_0/led_red_o]
  connect_bd_net -net pin_control_1_tp8_o [get_bd_ports tp8_o] [get_bd_pins pin_control_0/tp8_o]
  connect_bd_net -net pin_control_1_vadj_en_o [get_bd_ports vadj_en_o] [get_bd_pins pin_control_0/vadj_en_o]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins pin_control_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_pins SPI_3wire_0/proc_mosi] [get_bd_pins processing_system7_0/SPI0_MOSI_O]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_pins SPI_3wire_0/proc_sclk] [get_bd_pins processing_system7_0/SPI0_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI0_SS1_O [get_bd_pins SPI_3wire_0/proc_ss1] [get_bd_pins processing_system7_0/SPI0_SS1_O]
  connect_bd_net -net processing_system7_0_SPI0_SS2_O [get_bd_pins SPI_3wire_0/proc_ss2] [get_bd_pins processing_system7_0/SPI0_SS2_O]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pin_control_0/S_AXI/reg0] SEG_pin_control_0_reg0
