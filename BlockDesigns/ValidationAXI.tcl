...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins adc_control_saxi_0/S_AXI_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins pin_control_0/S_AXI_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
