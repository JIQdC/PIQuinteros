...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adc_DA2_n_i [ create_bd_port -dir I adc_DA2_n_i ]
  set adc_DA2_p_i [ create_bd_port -dir I adc_DA2_p_i ]
  ...
  # Create instance: data_MSB, and set properties
  set data_MSB [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 data_MSB ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {4} \
  ...
  # Create instance: ssel_LSB, and set properties
  set ssel_LSB [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 ssel_LSB ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {2} \
  ...
  # Create instance: ssel_MSB, and set properties
  set ssel_MSB [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 ssel_MSB ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {2} \
  ...
  connect_bd_net -net slice_data_1_Dout [get_bd_pins data_LSB/Dout] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net slice_data_2_Dout [get_bd_pins data_MSB/Dout] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net slice_frame_Dout [get_bd_pins deserializer_0/d_frame] [get_bd_pins slice_frame/Dout]
