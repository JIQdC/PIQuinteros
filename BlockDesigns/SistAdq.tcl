...
proc create_root_design { parentCell } {
  ...
  set led_red_o [ create_bd_port -dir O -from 0 -to 0 led_red_o ]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net reset_deb_Dout [get_bd_pins debug_control_0/rst_i] [get_bd_pins reset_deb/Dout]
  connect_bd_net -net reset_fifo_Dout [get_bd_pins fifo_generator_0/rst] [get_bd_pins reset_fifo/Dout]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports led_red_o] [get_bd_pins util_vector_logic_0/Res]
