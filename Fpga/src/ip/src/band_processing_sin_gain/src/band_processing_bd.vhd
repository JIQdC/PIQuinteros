...
architecture STRUCTURE of Band_filter_hier_imp_Q8IROE is
  component band_processing_bd_Band_filter_1 is
  port (
    aclk : in STD_LOGIC;
    s_axis_data_tvalid : in STD_LOGIC;
  ...
  end component band_processing_bd_Band_filter_1;
...
Band_filter: component band_processing_bd_Band_filter_1
     port map (
      aclk => aclk_0_1,
      m_axis_data_tdata(31 downto 0) => Band_filter_m_axis_data_tdata(31 downto 0),
      m_axis_data_tvalid => Band_filter_m_axis_data_tvalid,
...
architecture STRUCTURE of band_processing_bd is
  component band_processing_bd_Band_mixer_1 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component band_processing_bd_Band_mixer_1;
...
begin
  ...
  data_mux_out(15 downto 0) <= dsp_data_source_mux_0_m_axis_tdata(15 downto 0);
...
Band_mixer: component band_processing_bd_Band_mixer_1
     port map (
      aclk => adc_clk_0_1,
