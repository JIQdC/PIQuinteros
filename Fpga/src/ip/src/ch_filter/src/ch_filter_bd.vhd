...
architecture STRUCTURE of Ch_filter_hier_imp_PSQSKR is
  component ch_filter_bd_Channel_filter_0 is
  port (
    aclk : in STD_LOGIC;
    s_axis_data_tvalid : in STD_LOGIC;
  ...
  end component ch_filter_bd_Channel_filter_0;
...
begin
  ...
  aclk_0_1 <= adc_clk;
Channel_filter: component ch_filter_bd_Channel_filter_0
     port map (
      aclk => aclk_0_1,
