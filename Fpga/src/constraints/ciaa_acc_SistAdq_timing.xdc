...
set_max_delay \
    ...
    -to [get_pins adc_control_wrapper_inst/adc_receiver*_inst/ADC_data[*].sampler_data/dout_reg_reg[*]/D] $deserializer_max_delay
# false path to pulse synchronizer
set_false_path -to [get_pins adc_control_wrapper_inst/adc_receiver*_inst/ADC_data[*].pulse_sync_data/dest_pulse_reg_reg[0]/D]

# preprocessing registers CDC
# false path to synchronizers
set_false_path -to [get_pins adc_control_wrapper_inst/adc_receiver*_inst/fifo_input_mux_sel_sync_inst/sync_data_reg0_reg[*]/D]
...
# false path to synchronizers
set_false_path -to [get_pins adc_control_wrapper_inst/adc_receiver*_inst/debug_enable_sync_inst/dest_level_reg_reg[0]/D]
set_false_path -to [get_pins adc_control_wrapper_inst/adc_receiver*_inst/debug_control_sync_inst/sync_data_reg0_reg[*]/D]
set_false_path -to [get_pins adc_control_wrapper_inst/adc_receiver*_inst/debug_w2w1_sync_inst/sync_data_reg0_reg[*]/D]
