...
# -- Target Devices: 
# -- Tool Versions: 
# -- Description: Constraints file for CIAA-ACC SPI test project
# -- 
# -- Dependencies: None.
# -- 
# -- Revision: 2020-11-12
...
# Differential external clock on G7 and F7
#create_clock -name sys_clk -period 5.00 -waveform {0 2.5} [get_ports { SYSCLK_P }];
#set_property IOSTANDARD DIFF_HSTL_II_18 [get_ports { SYSCLK_P SYSCLK_N }];
#set_property PACKAGE_PIN G7 [get_ports SYSCLK_P]
#set_property PACKAGE_PIN F7 [get_ports SYSCLK_N] # Inferred from P pin
...
#set_property PACKAGE_PIN AE23 IOSTANDARD LVCMOS18 [get_ports {tp8_o}]
...
set_property PACKAGE_PIN A12 [get_ports gpio0_o]
set_property IOSTANDARD LVCMOS18 [get_ports gpio0_o]
...
#set_property PACKAGE_PIN B14 [get_ports gpio4_o[0]]
#set_property IOSTANDARD LVCMOS18 [get_ports gpio4_o[0]]
...
#set_property PACKAGE_PIN AD24 [get_ports rst_i]
...
#set_property PACKAGE_PIN AD25 [get_ports dout2_o[0]]
#set_property IOSTANDARD LVCMOS18 [get_ports dout2_o[0]]
# set_property PACKAGE_PIN AE25 [get_ports dout3_o]
# set_property IOSTANDARD LVCMOS18 [get_ports dout3_o]


# ----------------------------------------------------------------------------
# UART - Bank 13(VCCO_HR: VADJ)
# ----------------------------------------------------------------------------


# set_property PACKAGE_PIN AE23 [get_ports UART_TX]
...
# set_property IOSTANDARD LVCMOS18 [get_ports {adc_DCO1_i_clk_p}]
# #adc_DCO1- @ bank13
# set_property PACKAGE_PIN AD21 [get_ports {adc_DCO1_i_clk_n}]
# set_property IOSTANDARD LVDS_25 [get_ports {adc_DCO1_i_clk_n}]

#adc_FCO1+ @ bank13
set_property PACKAGE_PIN Y18 [get_ports {adc_fco1_i}]
set_property IOSTANDARD LVCMOS18 [get_ports {adc_fco1_i}]
# #adc_FCO1- @ bank13
# set_property PACKAGE_PIN AA18 [get_ports {adc_FCO1_n_i}]
# set_property IOSTANDARD LVDS_25 [get_ports {adc_FCO1_n_i}]
...
##adc_FCO2+ @ bank12
set_property PACKAGE_PIN AE11 [get_ports adc_fco2_i]
set_property IOSTANDARD LVCMOS18 [get_ports adc_fco2_i]
# ##adc_FCO2- @ bank12
# set_property PACKAGE_PIN AF10 [get_ports adc_FCO2_n_i]
# set_property IOSTANDARD LVDS_25 [get_ports adc_FCO2_n_i]

##D_A1+ @ bank12
#set_property PACKAGE_PIN AC13 [get_ports adc_DA1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DA1_p_i]
##D_A1- @ bank12
#set_property PACKAGE_PIN AD13 [get_ports adc_DA1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DA1_n_i]

##D_A2+ @ bank12
#set_property PACKAGE_PIN AE10 [get_ports adc_DA2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DA2_p_i]
##D_A2- @ bank12
#set_property PACKAGE_PIN AD10 [get_ports adc_DA2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DA2_n_i]

##D_B1+ @ bank12
#set_property PACKAGE_PIN Y10 [get_ports adc_DB1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DB1_p_i]
##D_B1- @ bank12
#set_property PACKAGE_PIN AA10 [get_ports adc_DB1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DB1_n_i]

##D_B2+ @ bank12
#set_property PACKAGE_PIN AB11 [get_ports adc_DB2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DB2_p_i]
##D_B2- @ bank12
#set_property PACKAGE_PIN AB10 [get_ports adc_DB2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DB2_n_i]

##D_C1+ @ bank12
#set_property PACKAGE_PIN Y12 [get_ports adc_DC1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DC1_p_i]
##D_C1- @ bank12
#set_property PACKAGE_PIN Y11 [get_ports adc_DC1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DC1_n_i]

##D_C2+ @ bank12
#set_property PACKAGE_PIN W13 [get_ports adc_DC2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DC2_p_i]
##D_C2- @ bank12
#set_property PACKAGE_PIN Y13 [get_ports adc_DC2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DC2_n_i]

##D_D1+ @ bank12
#set_property PACKAGE_PIN W16 [get_ports adc_DD1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DD1_p_i]
##D_D1- @ bank12
#set_property PACKAGE_PIN W15 [get_ports adc_DD1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DD1_n_i]

##D_D2+ @ bank12
#set_property PACKAGE_PIN Y17 [get_ports adc_DD2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DD2_p_i]
##D_D2- @ bank12
#set_property PACKAGE_PIN AA17 [get_ports adc_DD2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DD2_n_i]

##D_E1+ @ bank12
#set_property PACKAGE_PIN AE12 [get_ports adc_DE1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DE1_p_i]
##D_E1- @ bank12
#set_property PACKAGE_PIN AF12 [get_ports adc_DE1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DE1_n_i]

##D_E2+ @ bank12
#set_property PACKAGE_PIN Y16 [get_ports adc_DE2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DE2_p_i]
##D_E2- @ bank12
#set_property PACKAGE_PIN Y15 [get_ports adc_DE2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DE2_n_i]

##D_F1+ @ bank12
#set_property PACKAGE_PIN AE13 [get_ports adc_DF1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DF1_p_i]
##D_F1- @ bank12
#set_property PACKAGE_PIN AF13 [get_ports adc_DF1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DF1_n_i]

#D_F2+ @ bank12
# set_property PACKAGE_PIN AC23 [get_ports adc_DF2_p_i]
# set_property IOSTANDARD LVDS_25 [get_ports adc_DF2_p_i]
# #D_F2- @ bank12
# set_property PACKAGE_PIN AC24 [get_ports adc_DF2_n_i]
# set_property IOSTANDARD LVDS_25 [get_ports adc_DF2_n_i]

##D_G1+ @ bank12
#set_property PACKAGE_PIN AA13 [get_ports adc_DG1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DG1_p_i]
##D_G1- @ bank12
#set_property PACKAGE_PIN AA12 [get_ports adc_DG1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DG1_n_i]

##D_G2+ @ bank12
#set_property PACKAGE_PIN AA15 [get_ports adc_DG2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DG2_p_i]
##D_G2- @ bank12
#set_property PACKAGE_PIN AA14 [get_ports adc_DG2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DG2_n_i]

##D_H1+ @ bank12
#set_property PACKAGE_PIN AB12 [get_ports adc_DH1_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DH1_p_i]
##D_H1- @ bank12
#set_property PACKAGE_PIN AC11 [get_ports adc_DH1_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DH1_n_i]

##D_H2+ @ bank12
#set_property PACKAGE_PIN W18 [get_ports adc_DH2_p_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DH2_p_i]
##D_H2- @ bank12
#set_property PACKAGE_PIN W19 [get_ports adc_DH2_n_i]
#set_property IOSTANDARD LVDS_25 [get_ports adc_DH2_n_i]
...
# set_property PACKAGE_PIN AF19 [get_ports fmc_present]
# set_property IOSTANDARD LVCMOS18 [get_ports fmc_present]
...
# ----------------------------------------------------------------------------
# HDMI - Bank 35 (VCCO_HP: 1.5/1.8v @ J19)
# ----------------------------------------------------------------------------


# To be completed
#set_property PACKAGE_PIN AF23 IOSTANDARD LVCMOS18 [get_ports {hdmi_en_o}]


# ----------------------------------------------------------------------------
# PCIe - Bank 35 (VCCO_HP: 1.5/1.8v @ J19)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# BUS CAN - Bank 13 (VCCO_HR: VADJ)
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN AE22 IOSTANDARD LVCMOS18 [get_ports {can_rx_i}]
#set_property PACKAGE_PIN AF22 IOSTANDARD LVCMOS18 [get_ports {CAN_TX}]