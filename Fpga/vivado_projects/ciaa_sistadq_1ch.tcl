...
#
# ciaa_sistadq_1ch.tcl: Tcl script for re-creating project 'CIAA_SistAdq_1ch'
#
# Generated by Vivado on Thu Feb 04 00:03:22 -03 2021
...
#
# 1. This project restoration tcl script (ciaa_sistadq_1ch.tcl) that was generated.
#
...
#    "/home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/hdl/adc_control_wrapper_1ch.vhd"
...
#    "/home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/constraints/ciaa_acc_SistAdq_general_1ch.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "CIAA_SistAdq_1ch"
...
set script_file "ciaa_sistadq_1ch.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../VivadoProjects/CIAA_SistAdq_1ch"]"

# Create project
create_project ${_xil_proj_name_} "ciaa_sistadq_1ch_proj" -part xc7z030fbg676-2
...
set files [list \
 ...
 [file normalize "${origin_dir}/../src/hdl/adc_control_wrapper_1ch.vhd"] \
...
set file "$origin_dir/../src/hdl/adc_control_wrapper_1ch.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "adc_control_wrapper_1ch" -objects $obj
set_property -name "top_arch" -value "arch" -objects $obj
set_property -name "top_file" -value "../src/hdl/adc_control_wrapper_1ch.vhd" -objects $obj
...
set file "[file normalize "$origin_dir/../src/constraints/ciaa_acc_SistAdq_general_1ch.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../src/constraints/ciaa_acc_SistAdq_general_1ch.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../src/constraints/ciaa_acc_SistAdq_general_1ch.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../src/constraints/ciaa_acc_SistAdq_general_1ch.xdc"]" -objects $obj
...
if { [get_files adc_control_wrapper_1ch.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/hdl/adc_control_wrapper_1ch.vhd
}
...
# module references:
# adc_control_wrapper_1ch, delay_control, downsampler_control, pin_control
...
proc create_hier_cell_AXI_slow { parentCell nameHier } {
  ...
  connect_bd_net -net ADC_AcqControl_adc_FCOlck_o [get_bd_pins adc_FCO1lock_i] [get_bd_pins pin_control_0/adc_FCO1lock_i]
...
proc create_hier_cell_ADC_AcqControl { parentCell nameHier } {
  ...
  connect_bd_net -net ext_trigger_i_0_1 [get_bd_pins ext_trigger_i] [get_bd_pins adc_control_wrapper_1ch_0/ext_trigger_i]
  ...
  connect_bd_net -net ADC_AcqControl_adc_FCOlck_o [get_bd_pins ADC_AcqControl/adc_FCOlck_o] [get_bd_pins AXI_slow/adc_FCO1lock_i]
...
make_wrapper -files [get_files $proj_dir/$_xil_proj_name_.srcs/sources_1/bd/SistAdq/SistAdq.bd] -top
add_files -norecurse $proj_dir/$_xil_proj_name_.srcs/sources_1/bd/SistAdq/hdl/SistAdq_wrapper.vhd
set_property top SistAdq_wrapper [current_fileset]
