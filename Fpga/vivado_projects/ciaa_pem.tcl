...
# -- Target Devices: 
# -- Tool Versions: 
# -- Description: TCL script for recreating CIAA-ACC startup project
# -- 
# -- Dependencies: None.
# -- 
# -- Revision: 2020-11-12
...
#
# ciaa_pem.tcl: Tcl script for re-creating project 'CIAA_PEM'
#
# Generated by Vivado on Thu Nov 12 01:26:47 -03 2020
...
#
# 1. This project restoration tcl script (ciaa_pem.tcl) that was generated.
#
...
#    "/home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/constraints/ciaa_acc_PEM.xdc"
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/../../../VivadoProjects/CIAA_PEM"]"
...
set file "[file normalize "$origin_dir/../src/constraints/ciaa_acc_PEM.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../src/constraints/ciaa_acc_PEM.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../src/constraints/ciaa_acc_PEM.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../src/constraints/ciaa_acc_PEM.xdc"]" -objects $obj
...
# Proc to create BD CIAA_PEM
proc cr_bd_CIAA_PEM { parentCell } {
...
# pin_control_PEM
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins pin_control_PEM_0/S_AXI_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins pin_control_PEM_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pin_control_PEM_0/S_AXI/reg0] SEG_pin_control_PEM_0_reg0
...
# End of cr_bd_CIAA_PEM()
cr_bd_CIAA_PEM ""
set_property REGISTERED_WITH_MANAGER "1" [get_files CIAA_PEM.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files CIAA_PEM.bd ] 
...
make_wrapper -files [get_files "$proj_dir/${_xil_proj_name_}.srcs/sources_1/bd/CIAA_PEM/CIAA_PEM.bd"] -top
add_files -norecurse "$proj_dir/${_xil_proj_name_}.srcs/sources_1/bd/CIAA_PEM/hdl/CIAA_PEM_wrapper.vhd"
update_compile_order -fileset sources_1
set_property top CIAA_PEM_wrapper [current_fileset]