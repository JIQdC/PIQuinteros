...
# -- Target Devices: 
# -- Tool Versions: 
# -- Description: TCL script for recreating SPI test project
# -- 
# -- Dependencies: None.
# -- 
# -- Revision: 2020-11-12
# -- Additional Comments: Directory project will be created at the PATH where the 
# -- script is sourced. Make sure to clone entire PIQuinteros_repo first!
# -- 
# ----------------------------------------------------------------------------------
...
#
# spi_test.tcl: Tcl script for re-creating project 'SPI_test'
#
# Generated by Vivado on Thu Nov 12 01:38:01 -03 2020
...
#
# 1. This project restoration tcl script (spi_test.tcl) that was generated.
#
...
#
#    "/home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/hdl/pin_control_PEM.vhd"
#    "/home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/constraints/ciaa_acc_SPI_test.xdc"
#
#*****************************************************************************************

# Set the reference directory for source file relative paths (by default the value is script directory path)
set origin_dir "/home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/vivado_projects"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../VivadoProjects/SPI_test"]"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/hdl/pin_control_PEM.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/hdl/pin_control_PEM.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pin_control_PEM" -objects $obj
set_property -name "top_arch" -value "rtl" -objects $obj
set_property -name "top_file" -value "../src/hdl/pin_control_PEM.vhd" -objects $obj
...
set file "[file normalize "$origin_dir/../src/constraints/ciaa_acc_SPI_test.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../src/constraints/ciaa_acc_SPI_test.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../src/constraints/ciaa_acc_SPI_test.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../src/constraints/ciaa_acc_SPI_test.xdc"]" -objects $obj
...
if { [get_files pin_control_PEM.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/jiqdc/Documents/PI/PIQuinteros_repo/Fpga/src/hdl/pin_control_PEM.vhd
}


# Proc to create BD SPI_test
proc cr_bd_SPI_test { parentCell } {
...
# pin_control_PEM
  ...
  # Create ports
  set adc_fco1_i [ create_bd_port -dir I adc_fco1_i ]
  set adc_fco2_i [ create_bd_port -dir I adc_fco2_i ]
  ...
  set gpio0_o [ create_bd_port -dir O gpio0_o ]
  set gpio1_o [ create_bd_port -dir O gpio1_o ]
  set gpio2_o [ create_bd_port -dir O gpio2_o ]
  set gpio3_o [ create_bd_port -dir O gpio3_o ]
  ...
  # Create instance: pin_control_PEM_0, and set properties
  set block_name pin_control_PEM
  set block_cell_name pin_control_PEM_0
  if { [catch {set pin_control_PEM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pin_control_PEM_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins pin_control_PEM_0/S_AXI]
  ...
  connect_bd_net -net ACLK_1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_spi_control_0/s_axi_aclk] [get_bd_pins pin_control_PEM_0/S_AXI_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net adc_fco1_i_1 [get_bd_ports adc_fco1_i] [get_bd_ports gpio6_o]
  connect_bd_net -net adc_fco2_i_1 [get_bd_ports adc_fco2_i] [get_bd_ports gpio7_o]
  connect_bd_net -net axi_spi_control_0_adc_sclk_o [get_bd_ports adc_sclk_o] [get_bd_ports gpio1_o] [get_bd_pins axi_spi_control_0/adc_sclk_o]
  connect_bd_net -net axi_spi_control_0_adc_sdio_o [get_bd_ports adc_sdio_o] [get_bd_ports gpio0_o] [get_bd_pins axi_spi_control_0/adc_sdio_o]
  connect_bd_net -net axi_spi_control_0_adc_ss1_o [get_bd_ports adc_ss1_o] [get_bd_ports gpio2_o] [get_bd_pins axi_spi_control_0/adc_ss1_o]
  connect_bd_net -net axi_spi_control_0_adc_ss2_o [get_bd_ports adc_ss2_o] [get_bd_ports gpio3_o] [get_bd_pins axi_spi_control_0/adc_ss2_o]
  connect_bd_net -net pin_control_PEM_0_led_red_o [get_bd_ports led_red_o] [get_bd_pins pin_control_PEM_0/led_red_o]
  connect_bd_net -net pin_control_PEM_0_vadj_en_o [get_bd_ports vadj_en_o] [get_bd_pins pin_control_PEM_0/vadj_en_o]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_spi_control_0/s_axi_aresetn] [get_bd_pins pin_control_PEM_0/S_AXI_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_spi_control_0/s_axi/reg0] SEG_axi_spi_control_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pin_control_PEM_0/S_AXI/reg0] SEG_pin_control_PEM_0_reg0
...
# End of cr_bd_SPI_test()
cr_bd_SPI_test ""
set_property REGISTERED_WITH_MANAGER "1" [get_files SPI_test.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files SPI_test.bd ] 
...
# Create wrapper for BD
make_wrapper -files [get_files "$proj_dir/${_xil_proj_name_}.srcs/sources_1/bd/SPI_test/SPI_test.bd"] -top
add_files -norecurse "$proj_dir/${_xil_proj_name_}.srcs/sources_1/bd/SPI_test/hdl/SPI_test_wrapper.vhd"
update_compile_order -fileset sources_1
set_property top SPI_test_wrapper [current_fileset]